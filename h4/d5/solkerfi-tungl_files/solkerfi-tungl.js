...
function render() {
    ...
    rotDay += 1.0 * speeder;
    rotYear += 0.1 * speeder;        // not the correct value, but looks better!
    ...
    // teikna "tunglid"
    var mvt = mult(mv, rotateY(30.0 * rotYear));
    ...
    // teikna "gervitunglid"
    var mvt2 = mult( mvt, rotateZ( 15.0*rotYear ) );
    mvt2 = mult( mvt2, translate( 1.8, 0.0, 0.0 ) );
    mvt2 = mult( mvt2, scalem( 0.4, 0.4, 0.4 ) );
    gl.uniformMatrix4fv(matrixLoc, false, flatten(mvt2));
    gl.drawArrays( gl.TRIANGLES, 0, numVertices );
